...
const AdminSidePare = ({ allProducts, allOrders, addProduct, addBrand, addCategory, addSubcategory }) => {
    ...
    return (
        <>
            ...
            <div className={"max-w-[200px] lg:w-[210px]  lg:max-h-[80vh]  lg:h-[80vh]   bg-[#F9F9F9] max-lg:w-3/5 max-lg:max-w-[300px] max-lg:z-50  max-lg:pl-2 max-lg:pt-1 max-lg:fixed max-lg:left-0 max-lg:bottom-0 max-lg:top-0 max-lg:duration-[.6s] max-lg:ease-in-out " +
            ...
            <div className="lg:hidden max-lg:pl-2 mb-3" >
                <div onClick={() => setIsFilter(prev => prev === "[calc(100%+32px)]" ? 0 : "[calc(100%+32px)]")} className="cursor-pointer flex items-center ">
