                    ...
                    <div className="lg:w-3/4 max-lg:pl-2">
                        ...
                        <div className=" max-sm:w-full w-3/4 mt-4 ">
                            <div className=" flex w-full flex-col gap-4  ">
                                <input type="text" name="" id="" placeholder="Your Town" className="p-2
                                w-full  rounded-md  border border-[#c0c0c0]" />
                                <textarea name="" id="" rows="4" className=" rounded-md  border border-[#c0c0c0] resize-none p-2" placeholder="Your address with more details like (cairo,damitta,elroda,elhesar)"></textarea>
                                <input type="number" name="" id="" placeholder="Your Number" className="p-2
                                w-full  rounded-md  border border-[#c0c0c0]" />
                            </div>
                        </div>
