                ...
                <div className="mt-10">
                    ...
                    <div className="grid grid-col-1 md:grid-cols-2 ">
                        <div className="">
                            ...
                            <input type="number" name="" id="PhoneNumber" placeholder="Your Name" className=" py-2 px-3 mt-2  mb-6   w-full rounded-sm border border-[#c0c0c0]" />
                            <label htmlFor="email" className="ml-1 tracking-wider ">Email</label>
                            <input type="email" name="" id="email" placeholder="Your Name" className=" py-2 px-3 mt-2  mb-6   w-full rounded-sm border border-[#c0c0c0]" />
                            <label htmlFor="comment" className="ml-1 tracking-wider ">Comment</label>
                            <textarea name="" id="" placeholder="Your Comment" cols="30" rows="10" className="py-2 px-3 rounded-sm border border-[#c0c0c0] mt-2 w-full"></textarea>
                        ...
                        <div className="md:ml-20 p-6">
                            <div className="flex gap-3 items-center">
                                ...
                                <h1> <span className="font-semibold">HOTLINE </span>: 01093720956</h1>
                            </div>
                            <div className="mt-10">
