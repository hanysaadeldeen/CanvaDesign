    ...
    <>
      <div className={` pt-20 relative `}>
        ...
        <div className="container ">
          {/* header for show */}
          <div className="flex  items-center pb-3  child:text-[#999999] gap-1">
            <span className=" cursor-pointer">category </span>
            <span className="  text-2xl font-semibold "> {`>`}</span>
            <span className=" cursor-pointer">15 items </span>
          </div>
          <h1 className="mx-auto uppercase text-xl sm:text-2xl mt-5  text-center border-b-2 pb-2 font-light w-2/3 font-serif tracking-wide">t-shirt</h1>
          <div className="flex gap-4">
            ...
            <div className="max-lg:w-full w-[calc(100%-210px)] " >
              <div className="flex items-center justify-between lg:gap-5 lg:justify-end px-2 py-5 ">
                ...
                {/* this is hidden now */}
                {/* <div className="view-us flex gap-2 items-center ">
                  <h1 className="uppercase max-md:hidden">VIEW AS</h1>
                  <div className="flex  items-center gap-2">
                    <div className="VIEW-AS p-[3px] cursor-pointer border-2 duration-300 hover:border-black border-[#808080] flex flex-col gap-1  h-[30px] w-[40px]">
                      <h1 className=" bg-[#858585] h-2 "></h1>
                      <h1 className=" bg-[#858585] h-2 "></h1>
                      <h1 className=" bg-[#858585] h-2 "></h1>
                    </div>
                    <div className="p-[3px] VIEW-AS  cursor-pointer border-2 duration-300 hover:border-black border-[#808080] flex   gap-1  h-[30px] w-[25px]">
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                    </div>
                    <div className="p-[3px] VIEW-AS  cursor-pointer border-2 duration-300 hover:border-black border-[#808080] flex  max-md:hidden gap-1  h-[30px] w-[35px]">
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                    </div>
                    <div className="p-[3px] VIEW-AS  cursor-pointer border-2 duration-300 hover:border-black border-[#808080] flex  max-xl:hidden gap-1  h-[30px] w-[40px]">
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
                      <h1 className="bg-[#858585] h-full w-1.5"></h1>
              ...
              {/* products */}
              <div className="grid max-lg:pb-20 pb-10 grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                <ProductCard />
                <ProductCard />
                <ProductCard />
                <ProductCard />
