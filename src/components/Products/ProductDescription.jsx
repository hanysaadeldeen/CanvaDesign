...
const ProductDescription = () => {
    return (
        <div className="mb-5 mt-10 grid lg:grid-cols-4 md:grid-cols-2  sm:grid-cols-1  gap-5 description">
            <div>
                <h1 className="uppercase font-bold mb-2">high and leggy</h1>
                <p className="text-[#6F6F6F]">
                    {
                        "contouring pockets and Best Asset™ fabric hug here and lift there, creating curves in all the right places. They're made with premium Italian organic cotton that just gets better with time — the denim equivalent of classic rock. This version comes in a washed black and has a clean hem. "
                    }
                </p>
            </div>
            <div>
